...
sys.path.insert(0, str(ROOT/'artifacts/gpu_runtime'))
os.environ.setdefault('CUPY_CACHE_DIR', str(ROOT/'artifacts/cupy_cache'))
os.environ.setdefault('CUDA_PATH', str(ROOT/'artifacts/cuda_headers/nvidia/cuda_runtime'))
_dll = os.add_dll_directory(str(Path(torch.__file__).parent/'lib'))
import cupy as cp
