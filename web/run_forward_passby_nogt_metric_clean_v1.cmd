...
echo.
echo ============================================================
echo STEP 2 - Run no-GT metric forward pass-by on clean background
echo ============================================================

python render_forward_passby_nogt_metric_v1.py ^
  ...
  --output-dir D:\HallucinationEngine\web\outputs\tesla_forward_passby_nogt_metric_clean_v1 ^
  --frame-start 0 ^
  --frame-end 60 ^
  --frame-step 1 ^
