...
def main():
    ...
    try:
        ...
        for requested_depth in (
            ...
            print(
                f"[mask debug {requested_depth:5.1f} m] "
                f"physical vehicle px="
                f"{int(physical_vehicle_mask.sum())} "
                f"background vehicle px="
                f"{int(background_vehicle_mask.sum())} "
                f"target difference px="
            ...
            cv2.imwrite(
                str(
                    images_dir
                    /
                    f"depth_{depth_name}_carla.png"
                ),
                carla_annotated,
            )
            ...
            cv2.imwrite(
                str(
                    images_dir
                    /
                    f"depth_{depth_name}_comparison.png"
                ),
                comparison,
            )
            ...
            cv2.imwrite(
                str(
                    images_dir
                    /
                    f"depth_{depth_name}_overlay.png"
                ),
                overlay,
            )
            ...
            cv2.imwrite(
                str(
                    images_dir
                    /
                    f"depth_{depth_name}_carla_mask.png"
                ),
                (
                    physical_mask
                    .astype(
            ...
            cv2.imwrite(
                str(
                    images_dir
                    /
                    f"depth_{depth_name}_he_mask.png"
                ),
                (
                    he_mask
                    .astype(
