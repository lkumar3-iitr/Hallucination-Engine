"""Benchmark native-bank selection on poses from a recorded replay."""
...
from he_renderer.selector import Selector, transform
...
def main():
    ...
    parser.add_argument("--artifacts", type=Path, default=Path(__file__).parents[1] / "cache")
